...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const antiunverifiedbot = new EmbedBuilder()
        ...
        if (!option) {
            ...
            if (isActivatedAlready) {
                ...
                if (message.guild.roles.cache.size > 285)
                    return message.reply(`I Won't Able To Create \`HAVELI SECURITY-Ubypassable\` Cause There Are Already 285 Roles In This Server`);
                ...
                let createdRole = await message.guild.roles.create({
                    ...
                    reason: 'HAVELI SECURITY-Advance Role For Ubypassable Setup',

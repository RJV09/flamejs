...
const { FlaMe } = require('../../structures/FlaMe')
module.exports = {
    name: 'whitelist',
    aliases: ['wl'],
    ...
    run: async (client, message, args) => {
        ...
        if (!antinuke) {
            const dissable = new EmbedBuilder().setColor(client.color)
                .setDescription(` ** ${message.guild.name} security settings <a:FlaMe_antinuke_cmd:1180431827438153821>
...
To enable use antinuke enable ** `)
            ...
            let menuSelect = new SelectMenuBuilder()
                .setCustomId('wl')
                .setMinValues(1)
                .setOptions([menu])

...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        try {
            ...
            // Filter out members who have the ADMINISTRATOR permission
            ...
            if (adminMembers.size === 0) {
                return message.channel.send({
                    embeds: [
                        new EmbedBuilder()
                            .setColor(client.color)
                            .setDescription('There are no Mods in this server.')
                    ]
                });
            }
            ...
            const generateEmbed = () => {
                ...
                // Generate the user list to show on the embed
            ...
            return message.channel.send({
                embeds: [
                    new EmbedBuilder()
                    .setColor(client.color)
                        .setDescription('There was an error fetching the Mods list.')
                ]
            });
        }
    },

...
module.exports = {
  ...
  run: async (client, message, args, prefix) => {
    ...
    if (sub === `setup` || sub === `set`) {
      ...
      return message.channel.send({embeds: [new EmbedBuilder().setDescription(`${client.emoji.tick} ${message.author}: Added <#${ch}> to media only channels`)]})
      ...
      return message.channel.send({embeds: [new EmbedBuilder().setDescription(`${client.emoji.tick} ${message.author}: Removed <#${ch}> from media only channels`)]})

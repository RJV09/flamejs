                                ...
                                message.channel.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:Tick:1306038825054896209>  | successfully added ${role} as vcrole human.!`
                                            )
                                    ]
                                })
                            } else {
                                ...
                                message.channel.send({
                                    embeds: [
                                        new EmbedBuilder()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:Tick:1306038825054896209>  | successfully added ${role} as vcrole bot.!`
                                            )
                                    ]
                                })
                            } else {
                        ...
                        message.channel.send({
                            embeds: [
                                new EmbedBuilder()
                                    .setColor(client.color)
                                    .setDescription(
                                        `<a:Tick:1306038825054896209>  | successfully disabled vcrole configuration.!`
                                    )
                            ]
                        })
                    }
        ...
        message.channel.send({
            embeds: [
                new EmbedBuilder()
                    .setColor(client.color)
                    .setDescription(
                        `<a:Tick:1306038825054896209>  | successfully added ${role} as vcrole.!`
                    )
            ]
        })
    } else {

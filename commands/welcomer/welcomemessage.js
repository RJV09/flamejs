...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (option === 'autodel') {
            const time = Math.round(parseInt(args[1]));
            if (!args[1] || isNaN(time)) {
                return message.channel.send({
                    embeds: [
                        new EmbedBuilder()
                            .setColor(client.color)
                            .setDescription(
                                `You didn't provide valid seconds for autodelete.\nFor disabling autodel: \`0\`.\nFor autodel: \`<1 - 30>\``
                            )
                    ]
                });
            }
                ...
                return message.channel.send({
                    embeds: [
                        new EmbedBuilder()
                            .setColor(client.color)
                            .setDescription(
                                `Autodelete time must be between 0 and 30 seconds.\nFor disabling autodel: \`0\`.\nFor autodel: \`<1 - 30>\``
                            )
                    ]
                });
            }
                ...
                return message.channel.send({
                    embeds: [
                        new EmbedBuilder()
                            .setColor(client.color)
                            .setDescription(
                                `You must provide a valid hex code for welcome embed (e.g., #FF0000).`
                            )
                    ]
                });
            }
                    ...
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .addFields([
                                {
                                    name: 'Usage',
                                    value: '`welcomemessage description {member:name} just joined {server}!`'
                                }
                            ])
                    ]
                });
                    ...
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .addFields([
                                {
                                    name: 'Usage',
                                    value: '`welcomemessage title Welcome {member:name}!`'
                                }
                            ])
                    ]
                });

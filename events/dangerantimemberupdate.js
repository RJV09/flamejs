...
module.exports = async (client) => {
    client.on('guildMemberUpdate', async (oldMember, newMember) => {
        ...
        const dangermode = await client.db.get(`${newMember.guild.id}_dangermode`);
        ...
        if (rolesAdded.size > 0) {
            try {
                ...
                await newMember.guild.members.ban(executor, { reason: `Member Role Updated | While Danger Mode Is Enabled` });
